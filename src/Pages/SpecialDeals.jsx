...
function handleprice(pricerange){
  ...
  return (
    <div>
        <div id="banner">
            <img src="https://cdn.caratlane.com/media/static/images/V4/2023/CL/07-JULY/AppBanner/Flat20/01/Desktop_1920x560_toplisting.jpg" alt="" />
        </div>
        <div className="navdiv">
            <div className="navlist">
                ...
                <ul>
                    <li>
                        <a href="" style={{textDecoration:"none"}}>Bow  <CloseIcon color="red"  /></a>
                        <span></span>
