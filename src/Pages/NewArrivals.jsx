...
function handleprice(pricerange){
  ...
  return (
    <div>
        <div id="banner">
            <img src="https://cdn.caratlane.com/media/static/images/V4/2023/CL/07-JULY/AppBanner/Newin/01/Desktop_1920x560_toplisting.jpg" alt="" />
        </div>
        <div className="navdiv">
            <div className="navlist">
                ...
                <ul>
                    <li>
                        <a href="" style={{textDecoration:"none"}}>monthly new launches  <CloseIcon color="red"  /></a>
                        <span></span>
            ...
            <div class="total">
                <h1>July New Arrivals </h1>
                <span class="count"> 245 Designs
                </span>
            </div>
