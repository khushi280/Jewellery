...
function handleFilter(){
    let newdata=fData.filter((el)=>el.category ==="rings");
    setFData1(newdata);
    setFData2(newdata);
}
    ...
    <div>
        <div id="banner">
            ...
            <video  autoPlay loop playsInline muted>
                <source src="https://banner.caratlane.com/live-images/7428ab27c5984ebfa79c50391d62d8d2.mp4" type="video/mp4"
                    />
            </video>
        </div>
        <div className="navdiv">
            <div className="navlist">
                ...
                <ul>
                    <li>
                        <a href="" style={{textDecoration:"none"}}>Solitaires  <CloseIcon color="red"  /></a>
                        <span></span>
