...
function handleFilter(){
    let newdata=fData.filter((el)=>el.category ==="bracelet");
    setFData1(newdata);
    setFData2(newdata);
}
    ...
    <div>
        ...
        <div className="navdiv">
            <div className="navlist">
                ...
                <ul>
                    <li>
                        <a href="" style={{textDecoration:"none"}}>Bracelets  <CloseIcon color="red"  /></a>
                        <span></span>
                        <a href="" style={{textDecoration:"none"}}>Bangles  <CloseIcon color="red"  /></a>
                        <span></span>
            ...
            <div class="total">
                <h1>Bracelets & Bangles </h1>
                <span class="count"> 1075 Designs
                </span>
            </div>
                ...
                <div className="filterdiv">
                    ...
                    <div className="fillist">
                        ...
                        <div className="filcat">
                            ...
                            <label >
                                <i></i>
                                <Radio type="radio" name="checkbox" id="checkbox"  bg="#8863fb"></Radio>
                                    <span className="filtext">
