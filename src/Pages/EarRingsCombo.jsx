...
function handleFilter(){
    let newdata=fData.filter((el)=>(el.category ==="earrings") || (el.category === "rings"));
    setFData1(newdata);
    setFData2(newdata);
}
function handleprice(pricerange){
  ...
  return (
    <div>
        <div id="banner">
            <img src="https://assets.cltstatic.com/images/responsive/DefaultBanner_Desktop.webp" alt="" />
        </div>
            ...
            <div className="navlist">
                ...
                <ul>
                    <li>
                        ...
                        <span></span>
                        <a href="" style={{textDecoration:"none"}}>Rings  <CloseIcon color="red"  /></a>
                        <span></span>
